...
<div class="page_body">
	...
	<h3 align="center">
		...
		&nbsp;${(dir_name).split(': ')[1]} - Uncommitted Apps
	</h3>
	<hr>
	<br>
				...
				<div class="panel panel-default">
					<div class="panel-body">
						<table id="tableBranchData"
							...
							<c:forEach items="${diruncomm_table}" var="diruncomm"><tr>
								<td>${diruncomm.app_id}</td>
								<td>
								<c:choose>
											<c:when test='${diruncomm.app_name == null}'>
       N/A
    </c:when>
											<c:otherwise>
        ${diruncomm.app_name}
								...
								<td>${diruncomm.func_grp}</td>
								<td style="text-align: center;">${diruncomm.svp_name.split(': ')[1]}</td>
								<td style="text-align: center;">
								<c:choose>
											<c:when test='${diruncomm.eman_priority == null}'>
       N/A
    </c:when>
											<c:otherwise>
        ${diruncomm.eman_priority}
    </c:otherwise>
										</c:choose></td>
							</tr></c:forEach>
