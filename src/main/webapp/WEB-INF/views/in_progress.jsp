...
<div class="page_body">
	...
	<h3 align="center">
		...
		&nbsp;Cisco IT - Migration In Progress
	</h3>
	<hr>
	<br>
				...
				<div class="panel panel-default">
					<div class="panel-body">
						<table id="tableBranchData"
							...
							<c:forEach items="${progress_table}" var="progress"><tr>
								<td>${progress.app_id}</td>
								<td>${progress.func_grp}</td>
								<%-- <td style="text-align: center;">${uncomm.app_id}</td> --%>
								<td>${progress.svp}</td>
								<td>${progress.director_name.split(': ')[1]}</td>
							</tr></c:forEach>
