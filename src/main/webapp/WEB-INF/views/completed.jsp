...
<div class="page_body">
	...
	<h3 align="center">
		<span class="glyphicon glyphicon-th"
			style="margin-top: 1%; color: green;" title="Tooltip here"></span>
		&nbsp;Cisco IT - Completed Apps
	</h3>
	<hr>
	<br>
				...
				<div class="panel panel-default">
					<div class="panel-body">
						<table id="tableBranchData"
							...
							<c:forEach items="${completed_table}" var="completed"><tr>
								<td>${completed.app_id}</td>
								<td>${completed.func_grp}</td>
								<%-- <td style="text-align: center;">${uncomm.app_id}</td> --%>
								<td>${completed.svp}</td>
								<td>${completed.director_name.split(': ')[1]}</td>
								<td>${completed.mig_date}</td>
							</tr></c:forEach>
