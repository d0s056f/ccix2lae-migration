				...
				<div class="panel panel-default">
					<div class="panel-body">
						<table id="tableBranchData"
							...
							<c:forEach items="${offcomm_table}" var="offcomm"><tr>
								<td>${offcomm.app_id}</td>
								<td>
								<c:choose>
											<c:when test='${offcomm.app_name == null}'>
       N/A
    </c:when>
											<c:otherwise>
        ${offcomm.app_name}
								...
								<td>${offcomm.func_grp}</td>
								<td style="text-align: center;">${offcomm.svp_name.split(': ')[1]}</td>
								<td style="text-align: center;">
								<c:choose>
											<c:when test='${offcomm.eman_priority == null}'>
       N/A
    </c:when>
											<c:otherwise>
        ${offcomm.eman_priority}
    </c:otherwise>
										</c:choose></td>
								<td style="text-align: center;">${offcomm.mig_date}</td>
							</tr></c:forEach>
